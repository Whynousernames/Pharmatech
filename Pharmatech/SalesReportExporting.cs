...
namespace Pharmatech
{
    public class SalesReportExporting
    {
        ...
        public static void ExportDataTableToPdf(DataTable dtblTable, String strPdfPath, string strHeader, string saleType, string startDate, string endDate)
        {
            ...
            parameters.Add(new Chunk("Parameters Entered - " + "\n", fntAuthor));
            parameters.Add(new Chunk("Dates: " + startDate + " To " + endDate +  "\n", fntAuthor));
            parameters.Add(new Chunk("Sale Type: " + saleType + "\n", fntAuthor));
            parameters.Add(new Chunk("By Employee: " + "\n", fntAuthor));
            parameters.Add(new Chunk("By Patient: ", fntAuthor));
            ...
            table.SetWidths(new int[] { 1, 1, 2, 1, 2, 1, 1, 1});
            //Table header
